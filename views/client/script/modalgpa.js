...
// user1
  $('#more_btn5631050421').click(function() {
      setTimeout(function() {
...
// user3
  $('#more_btn5631063621').click(function() {
      setTimeout(function() {

     $('#chart1_5631063621').highcharts({
              title: {
                  text: 'ข้อมูล GPA ตามปีการศึกษา',
                  x: -20 //center
              },
...
// user5
  $('#more_btn5630648621').click(function() {
      setTimeout(function() {
     ...
     $('#chart1_5630648621').highcharts({
      ...
      setTimeout(function() {
          var chart =  $("#chart1_5630648621").highcharts();
          chart.reflow();
          chart.redraw();
